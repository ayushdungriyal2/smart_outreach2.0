...
from .tasks import get_domain_from_cloudfare, add_domain_to_zoho_request, create_user_zoho, get_domain_from_zoho,create_user_zoho_smartlead
import json
    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            # making celery task dictionary and running the task 
                ...
                print(domain_name)
                task_id = add_domain_to_zoho_request.delay(domain_name, mail_1, mail_2, refresh_token,
    ...
    if request.user.is_authenticated:
            ...
            if request.method == 'POST':
                ...
                # making celery task dictionary and running the task 
                    ...
                    print(domain_name)
                    task_id = create_user_zoho.delay(created_email,name,password,refresh_token,client_id,client_secret,zoho_domain)
    ...
    if request.user.is_authenticated:
            ...
            if request.method == 'POST':
                ...
                # making celery task dictionary and running the task 
                    ...
                    print(domain_name)
                    task_id = create_user_zoho_smartlead.delay(created_email,name,password,refresh_token,client_id,client_secret,zoho_domain,smart_lead_api_key)
